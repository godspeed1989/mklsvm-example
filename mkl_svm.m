% mklsvm simple interface

function mkl_svm(data, labels, classcode, ntrain, ntest)
%
% labels        :   (NSample+NTest) x 1
% data          :   (NSample+NTest) x FeatureVectorSize
% classcode     :   label classes
% ntrain        :   num of train samples
% ntest         :   num of test samples
%

    nbiter=1;
    C = [100];  % SVM hyperparameter
    verbose=1;
...
dim = size(data,2);
    ...
    % 
    [xapp,yapp,xtest,ytest,indice]=CreateDataAppTest(data, labels, ntrain, classcode);
    %
